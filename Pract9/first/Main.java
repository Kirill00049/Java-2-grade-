...
public class Main {
    public static void main(String[] args) {
        Student[] students = new Student[]{
                new Student("Danya","cheeeel",7,20,17460,1),
                new Student("Vladik","mirnyi",23,110,34264,2),
                new Student("Kirill","kit",1,224,43450,3),
                new Student("Mars","student",3,123,23452,4)
        };
        ...
        Student[] students2 = new Student[]{
                new Student("Lika","cheeeel",2,139,14324,5),
                new Student("Valera","dobryak",4,310,62137,4),
                new Student("Nika","manager",1,113,92359,3),
                new Student("Andrew","doctor",3,2,52346,5)
        };
